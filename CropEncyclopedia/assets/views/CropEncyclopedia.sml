<lane orientation="vertical" padding="10">
  <banner background={@Mods/StardewUI/Sprites/BannerBackground} background-border-thickness="48,0" padding="12" text="Crop Encyclopedia" />
  <lane orientation="horizontal">
    ...
    <lane orientation="vertical" horizontal-content-alignment="middle">
          ...
          <frame padding="16" background={@Mods/StardewUI/Sprites/ControlBorder} >
            <lane orientation="horizontal">
              <lane focusable="true" orientation="horizontal" vertical-content-alignment="middle" >
                <label bold="true" max-lines="1" layout="240px content" text="Name" click=|sortBy("Name")| />
                <label bold="true" max-lines="1" layout="36px content" margin="8" text="" />
                <label bold="true" max-lines="1" layout="48px content" text="D" click=|sortBy("Growth days")| />
                <label bold="true" max-lines="1" layout="48px content" text="R" click=|sortBy("Regrowth days")|/>
                <label bold="true" max-lines="1" layout="48px content" text="#" click=|sortBy("Harvests")|/>
                <label bold="true" max-lines="1" layout="100px content" text="G"  click=|sortBy("Gold")| />
                <label bold="true" max-lines="1" layout="100px content" text="G/d" click=|sortBy("Gold/day")| />
                <label bold="true" max-lines="1" layout="94px content" text="Date" click=|sortBy("Harvest day")| />
                <label bold="true" max-lines="1" layout="168px content" text="Seasons"  />
      ...
      <lane orientation="horizontal" horizontal-content-alignment="middle" vertical-content-alignment="middle" margin="0,8">
        <button text="Prev" *if={<hasPrevPage} click=|prevPage()| />
        <button text="Prev" *!if={<hasPrevPage} hover-background-tint="#808080"  default-background-tint="#808080" />
        <frame background={@Mods/StardewUI/Sprites/ControlBorder}  margin="0,8" padding="10">
          <lane orientation="horizontal" layout="100px content" margin="10,10" horizontal-content-alignment="middle" >
            ...
            <label margin="0,0,8,0" text="of" />
            <label margin="0,0,8,0" text={<pageCount} />
          </lane>
        </frame>
        <button text="Next" *if={<hasNextPage} click=|nextPage()|/>
        <button text="Next" *!if={<hasNextPage} hover-background-tint="#808080" default-background-tint="#808080"/>
      </lane>
    </lane>
  </lane>
</lane>
